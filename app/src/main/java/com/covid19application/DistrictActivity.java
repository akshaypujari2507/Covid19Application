...
import com.covid19application.adapters.DistrictAdapter;
import com.covid19application.adapters.StateAdapter;
import com.covid19application.network.Retrofit.RFInterface;
import com.covid19application.network.Retrofit.ResponseModels.statewise.DistrictDatum;
...
public class DistrictActivity extends AppCompatActivity implements DistrictAdapter.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new DownloadStatesData("https://api.covid19india.org/").execute("");
